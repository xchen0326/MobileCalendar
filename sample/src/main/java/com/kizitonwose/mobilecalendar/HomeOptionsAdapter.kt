...
import com.kizitonwose.mobilecalendar.databinding.HomeOptionsItemViewBinding
...
class HomeOptionsAdapter(val onClick: (ExampleItem) -> Unit) :
    ...
    val examples = listOf(
        ExampleItem(R.string.calendar_title, R.string.calendar_title) { CalendarFragment() }
    )
